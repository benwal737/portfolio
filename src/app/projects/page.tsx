...
export default function Projects() {
  const projects = [
    {
      title: "SlugTrail - Parking Solutions Platform",
      description:
    ...
    {
      title: "Werewolf - Multiplayer Web Game",
      description:
    ...
    {
      title: "Apokatastasis - Multi-POV Streaming Platform",
      description:
    ...
    <div className="min-h-[calc(100vh-4rem)] py-8 md:py-12">
      <main className="container mx-auto px-4 md:px-5 lg:px-20">
        ...
        <section className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-xl text-muted-foreground mx-auto px-4 md:px-0">
              ...
              <div className="block lg:hidden space-y-4 md:space-y-6">
                ...
                <div className="space-y-4 px-2">
                  ...
                  <div className="flex flex-col gap-3 pt-2">
                    ...
                    {project.openSource && (
                      <Button asChild variant="outline" className="px-4 w-full">
                        <Link
                          href={project.github || ""}
                          target="_blank"
                          rel="noopener noreferrer"
